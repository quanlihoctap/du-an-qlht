...
class _StudentDetailScreenState extends State<StudentDetailScreen> {
  ...
  void initState() {
    super.initState();
    studentIdController.text = widget.student.id;
    nameController.text = widget.student.name;
    birthDayController.text = widget.student.birthDate;
    addressController.text = widget.student.address;
    emailController.text = widget.student.email;
    _avatarFile =
        widget.student.avatar.isNotEmpty ? File(widget.student.avatar) : null;
  }
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        box.delete(widget.student.id);

                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Xoá thông tin thành công')),
                          );
                        }
